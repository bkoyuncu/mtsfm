...
class Mixture(Distribution):
    ...
    def log_prob(self, value: torch.Tensor) -> torch.Tensor:
        ...
        return (weights_log_probs + components_log_probs).logsumexp(dim=0) #each has shape (#components,bs,max_len,patch_size)-> output is total probs shape (bs,max_len,patch_size)
